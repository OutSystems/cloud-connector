...
> :information_source: cloud-connector supports connecting to endpoints both with and without TLS/SSL. It's important that you connect only to trusted endpoints.
