...
> :information_source: Some Webservers has issues accepting connections from outsystemscc, when using SSL. In this case the "onBeforeRequest" action in the app should be used to override the Host header, with the same endpoint (URL server).
